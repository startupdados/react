...
import Alert from '@mui/material/Alert'; // Importar Alert para estilos de alerta
      ...
      <Formik
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          try {
            ...
            setSnackbarMessage(err.message || 'Failed to login'); // Define a mensagem do Snackbar
